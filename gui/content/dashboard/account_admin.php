...
$account_admin = new Account_Management($connection, $_GET['id']);

if(!$account_admin->confirm_account_id()){
    header('Location: dashboard.php'); // redirect if value is not a valid int
}
...
$form_action = "dashboard.php?page=account&id=". $account_admin->get_user_id();
...
<html lang="en" dir="ltr">
	...
	<body>
		<nav>
            ...
            <!-- Navigation Title -->
			<name><label class="logo"><a href="dashboard.php?page=general" class="back-arrow"><i class="fas fa-arrow-circle-left"></i></a><span class="logo-label">Account Manager</span></label></name>
                    ...
                    <section>
                        <div class="content">
                            ...
                            <div class="config-form" id="change-birthday-form" style="display: none;">
                                <form action="<?php echo $form_action; ?>" method="post" id="change_birthday" name="change_birthday">
                            ...
                            <!-- BUTTON: Change Birthday - Save Button -->
                            ...
                            <div class="config-form" id="change-email-form" style="display: none;">
                                <form action="<?php echo $form_action; ?>" method="post" id="change_email" name="change_email">
                            ...
                            <!-- BUTTON: Change Email - Save Button -->
                            ...
                            <div class="config-form" id="change-password-form" style="display: none;">
                                <form action="<?php echo $form_action; ?>" method="post" id="change_password" name="change_password">
